    ...
    <div class="product-b">
        <div class="w1200">
            <ul class="product-b-ul">
                {pboot:search num=8 page=1 istop=0}
                <li>
                    <a href="[search:link]" target="_blank">
                        <div class="product-b1">
                            <img src="[search:ico]" alt="​[search:subtitle]">
                        </div>
                        <div class="product-b2">
                            <div class="product-b2-a">[search:title]</div>
                        </div>
                    </a>
                </li>
                {/pboot:search}
...
{/pboot:if}
  ...
  2 => '/data/wwwroot/elephant/template/default/product/menu.html',
  3 => '/data/wwwroot/elephant/template/default/comm/page.html',
  4 => '/data/wwwroot/elephant/template/default/comm/footer.html',
  5 => '/data/wwwroot/elephant/template/default/comm/nav-pc.html',
  6 => '/data/wwwroot/elephant/template/default/comm/nav-m.html',
); ?>